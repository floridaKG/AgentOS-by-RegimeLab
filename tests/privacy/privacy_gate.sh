...
gate "owner_service_ids" bash -c "cd '$STAGE' && rg -i 'floridakg|hwymwmhshzmhkewusdec|regime-lab\\\\.com' '.' --hidden --no-ignore -g '!droid-wiki/**' -g '!.git/**' -g '!.ossbuild/**' -g '!tests/**' -g '!PRIVACY_BOUNDARY.md' -g '!README.md' -g '!SETUP.md' -g '!LICENSE' -g '!RELEASE_READINESS.md' -g '!SECURITY.md' -g '!CODE_OF_CONDUCT.md' -g '!pyproject.toml' -g '!bootstrap.sh' -g '!docs/codegraph-setup.md' -g '!docs/launch/**' -g '!docs/assets/**' -g '!docs/ARCHITECTURE.md'; rc=\$?; if [ \$rc -eq 0 ]; then exit 1; elif [ \$rc -eq 1 ]; then exit 0; else exit 2; fi"
...
gate "regimelab_refs" bash -c "cd '$STAGE' && rg -i 'regimelab|regime-lab' '.' --hidden --no-ignore -g '!EXPORT_MANIFEST.yaml' -g '!droid-wiki/**' -g '!.git/**' -g '!.ossbuild/**' -g '!tests/**' -g '!examples/**' -g '!PRIVACY_BOUNDARY.md' -g '!scripts/gate-privacy.sh' -g '!scripts/gate-release.sh' -g '!README.md' -g '!SETUP.md' -g '!LICENSE' -g '!RELEASE_READINESS.md' -g '!docs/codegraph-setup.md' -g '!SECURITY.md' -g '!CODE_OF_CONDUCT.md' -g '!pyproject.toml' -g '!bootstrap.sh' -g '!docs/launch/**' -g '!docs/assets/**' -g '!docs/ARCHITECTURE.md' -g '!COMMERCIAL_BOUNDARY.md'; rc=\$?; if [ \$rc -eq 0 ]; then exit 1; elif [ \$rc -eq 1 ]; then exit 0; else exit 2; fi"
